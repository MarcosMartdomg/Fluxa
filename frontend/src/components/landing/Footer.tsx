        ...
        <div className="grid md:grid-cols-12 gap-12">
          <div className="md:col-span-5">
            <div className="flex items-center gap-2 mb-6">
              <img src="/images/logo_footer.png" alt="Fluxa Logo" className="h-[22px] w-auto" />
            </div>
            <p className="text-xl font-bold text-gray-900 mb-2 leading-tight">
              Automatización inteligente <br /> basada en eventos.
            </p>
            <p className="text-xs text-gray-400 mt-4 font-medium">Fluxa 2026</p>
          </div>

          <div className="md:col-span-2">
            <h4 className="text-sm font-bold text-gray-900 mb-6">Product</h4>
            <ul className="space-y-4">
              <li><a href="#" className="text-sm font-medium text-gray-500 hover:text-brand-600 transition-colors">Product</a></li>
              <li><a href="#" className="text-sm font-medium text-gray-500 hover:text-brand-600 transition-colors">Features</a></li>
              <li><a href="#" className="text-sm font-medium text-gray-500 hover:text-brand-600 transition-colors">Use Cases</a></li>
            </ul>
          </div>

          <div className="md:col-span-2">
            <h4 className="text-sm font-bold text-gray-900 mb-6">Docs</h4>
            <ul className="space-y-4">
              <li><a href="#" className="text-sm font-medium text-gray-500 hover:text-brand-600 transition-colors">Docs</a></li>
              <li><a href="#" className="text-sm font-medium text-gray-500 hover:text-brand-600 transition-colors">Pricing</a></li>
            </ul>
          </div>

          <div className="md:col-span-3">
            <h4 className="text-sm font-bold text-gray-900 mb-6">Prueba en el movil</h4>
            <div className="space-y-3">
              <button className="flex items-center gap-3 px-4 py-2 rounded-full border border-gray-200 text-[10px] font-bold text-gray-500 hover:bg-gray-50 transition-colors w-full max-w-[120px]">
      ...
      <div className="bg-[#6366F1] py-4">
        <div className="max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-16 xl:px-24 flex justify-between items-center text-[10px] text-white/80 font-medium">
          ...
          <div className="flex gap-4">
            ...
            <a href="#" className="hover:text-white transition-colors">Privacity</a>
          </div>
        </div>
      </div>
    </footer>
